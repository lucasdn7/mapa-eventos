...
Se o erro persistir por configuração antiga do projeto no painel da Vercel, ajuste **Project Settings → Build & Development Settings → Framework Preset** para **Other** e faça um novo deploy sem cache.
